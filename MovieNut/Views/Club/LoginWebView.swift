...
struct LoginWebView: UIViewRepresentable {
    ...
    let url = URL(string: "https://pnut.io/oauth/authenticate?client_id=cm-Jnn2MRXyLpKDJ7RE0OWE49MBCGu4H&redirect_uri=movienut://auth&scope=public_messages:io.pnut.core.chat,write_post&response_type=token&simple_login=1")!
